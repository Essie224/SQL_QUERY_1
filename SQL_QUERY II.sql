-- Created Tables: Project_CATEGORIES                                          

CREATE TABLE CATEGORIES(CATEGORY_CODE int NOT NULL,
             CATEGORY_NAME VARCHAR(25)    NOT NULL,
              DESCRIPTION  VARCHAR(100)   NOT NULL,
   CONSTRAINT PK_CATEGORIES PRIMARY KEY (CATEGORY_CODE)
   );

CREATE TABLE CUSTOMERSS(CUSTOMER_CODE CHAR(5) NOT NULL,
...
-- rename table
EXEC sp_rename 'CUSTOMERSS', 'CUSTOMERS';
SELECT * FROM CUSTOMERS

CREATE TABLE ORDERS(ORDER_int int   NOT NULL,
...
CREATE TABLE ORDER_DETAILS(ORDER_int INT  NOT NULL,
...
CREATE TABLE EMPLOYEES (EMPLOYEE_int int   NOT NULL,
             REPORTS_TO         int,
...
CREATE TABLE SUPPLIERS(SUPPLIER_int  int   NOT NULL,
             COMPANY    NVARCHAR(40)       NOT NULL,
             ADDRESS    NVARCHAR(60)       NOT NULL,
             CITY        VARCHAR(30)       NOT NULL,
            POSTAL_CODE  VARCHAR(10)       NOT NULL,
...
CREATE TABLE PRODUCTS(PRODUCT_REF  int      NOT NULL,
...
INSERT INTO EMPLOYEES 
      VALUES (2, 2, 'Fuller', 'Andrew', 'Vice President', 'Dr.', '02/9/1952', '08/4/1992', 10000.00, NULL), 
...
VALUES('ALFKI','Alfreds Futterkiste','Obere Str. 57','Berlin','12209','Allemagne','030-0074321','030-0076545' ),
...
VALUES (1,'Exotic Liquids','49 Gilbert St.','London','EC1 4SD','Royaume-Uni','(171) 555-2222',''),
...
VALUES (1, 'Chai', 1, 1, '10 boxes x 20 bags', 90.00, 39, 0, 0),
       ...
       (15, 'Genen Shouyu', 6, 2, '24 bottles (250 ml)', 78.00,0,0,0);
